...
export default async function handler(req, res) {
	const jql =
	'project = "Service Request" AND (status = Resolved OR status = Closed) AND assignee in membersOf(IT-OSS) AND resolution = Done AND "Time to resolution" = completed() AND "Time to resolution" != breached() '
    const fields =
